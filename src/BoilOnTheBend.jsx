...
export default function BoilOnTheBend() {
  ...
  // Pre-reg form state
  const [preReg, setPreReg] = useState({ firstName: "", lastName: "", email: "", phone: "", ranch: "", party: 1, amount: 85, sponsorId: "", status: "Paid" });
            ...
            {showPreReg && (
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>First Name *</label><input style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.firstName} onChange={(e) => setPreReg((p) => ({ ...p, firstName: e.target.value }))} placeholder="Jane" /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Last Name *</label><input style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.lastName} onChange={(e) => setPreReg((p) => ({ ...p, lastName: e.target.value }))} placeholder="Boudreaux" /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Email</label><input style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.email} onChange={(e) => setPreReg((p) => ({ ...p, email: e.target.value }))} placeholder="jane@example.com" /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Phone</label><input style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.phone} onChange={(e) => setPreReg((p) => ({ ...p, phone: e.target.value }))} placeholder="(337) 555-0199" /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Ranch / Company</label><input style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.ranch} onChange={(e) => setPreReg((p) => ({ ...p, ranch: e.target.value }))} placeholder="Double T Ranch" /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Sponsor</label><select style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box", background: "#fff" }} value={preReg.sponsorId} onChange={(e) => setPreReg((p) => ({ ...p, sponsorId: e.target.value }))}><option value="">— None —</option>{sponsors.map((s) => <option key={s.id} value={s.id}>{s.name}</option>)}</select></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Party Size</label><input type="number" min="1" max="20" style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.party} onChange={(e) => setPreReg((p) => ({ ...p, party: e.target.value }))} /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Amount Paid ($)</label><input type="number" min="0" step="0.01" style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box" }} value={preReg.amount} onChange={(e) => setPreReg((p) => ({ ...p, amount: e.target.value }))} /></div>
                  <div><label style={{ fontSize: 12, fontWeight: 600, color: "var(--inkSoft)", display: "block", marginBottom: 4 }}>Status</label><select style={{ fontFamily: "inherit", fontSize: 13.5, padding: "9px 11px", border: "1.5px solid var(--line)", borderRadius: 9, width: "100%", boxSizing: "border-box", background: "#fff" }} value={preReg.status} onChange={(e) => setPreReg((p) => ({ ...p, status: e.target.value }))}><option value="Paid">Paid</option><option value="Pending">Pending</option><option value="Comp">Comp</option></select></div>
                </div>
